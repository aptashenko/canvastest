<template>
    ...
    <div class="panel">
      <ul class="list">
        <li @click="takeColor" v-for="(color, i) of colors" :key="i + 'color'" :style="{backgroundColor: color}" class="palitra"></li>
      </ul>
...
export default {
  setup() {
    ...
    return { canvas, takeColor, toggleMouseDown, draw, setBrushWidth, colors }
  }
}
</script>
